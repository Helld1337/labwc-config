...
pkgs="foot fuzzel labwc mako waybar swaybg wlr-randr wl-clipboard slurp grim cliphist pavucontrol pipewire pipewire-pulse pipewire-jack nm-connection-editor nwg-look swappy adwaita-fonts noto-fonts"
